(() => {
  ...
  function markDynamicImagesPending(){
    const selectors=['.hero-visual img','.collection-card img','.statement-art img','.gallery-item img','.final-art img'];
