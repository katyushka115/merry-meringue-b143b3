...
(()=>{
  ...
  async function run(){
    const results=await Promise.allSettled([
      ...
      json('/rest/v1/products?select=id,name,description,price,image_url,is_active,is_featured,sort_order&is_active=eq.true&order=sort_order.asc&order=id.asc')
    ]);
